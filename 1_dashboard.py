...
class DashboardPage(QWidget):
    def __init__(self):
        ...
        welcome_label = QLabel("Welcome to Flora Dashboard")
        welcome_label.setStyleSheet("font-size: 24px; font-weight: bold; color: #2c3e50;")
        welcome_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        content_layout.addWidget(welcome_label)
        
        content = QLabel("\nManage your crop records and view detailed reports.\n\nUse the sidebar to navigate between different sections.")
        content.setWordWrap(True)
        content.setStyleSheet("font-size: 14px; color: #2d3436;")
...
class ReportsPage(QWidget):
    def __init__(self):
        ...
        basic_title.setStyleSheet("font-size: 18px; font-weight: bold; color: #2c3e50; margin-top: 20px; margin-bottom: 10px;")
        ...
        detailed_title.setStyleSheet("font-size: 18px; font-weight: bold; color: #2c3e50; margin-top: 20px; margin-bottom: 10px;")
        ...
        seasonal_title.setStyleSheet("font-size: 18px; font-weight: bold; color: #2c3e50; margin-top: 20px; margin-bottom: 10px;")
